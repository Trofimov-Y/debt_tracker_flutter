    ...
    return ListTile(
      ...
      leading: CircleAvatar(
        ...
        child: switch (action.type) {
          ActionType.create => const Icon(Icons.new_releases),
          ActionType.delete => const Icon(Icons.delete),
          ActionType.partialRepayment => const Icon(Icons.money_off),
          ActionType.fullRepayment => const Icon(Icons.money),
          ActionType.partialAdditionDebt => const Icon(Icons.money),
        },
      ),
